...
#fnames = ['chess_train_elite_tiny.pt', 'chess_val_elite_tiny.pt', 'chess_test_elite_tiny.pt']
#specnames = ['chess_elite_tiny.json']
...
torch.save(model, os.path.join(data_dir, 'model_fulldata.pt'))